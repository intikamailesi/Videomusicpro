...
API_ID = int(getenv("API_ID", "20235833"))
...
MUSIC_BOT_NAME = getenv("MUSIC_BOT_NAME", "bivideomusicbot")
...
UPSTREAM_REPO = getenv(
    "UPSTREAM_REPO",
    "https://github.com/intikamailesi/Videomusicpro",
)
...
SUPPORT_CHANNEL = getenv(
    "SUPPORT_CHANNEL", "https://t.me/BiVideoMuzikKomutlar"
